...
public final class FoundationOreFeatures {
    ...
    //Features
    public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_ALUMINUM = FeatureUtils.createKey(UsefulFoundation.getId("ore_aluminum").toString());
    public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_LEAD = FeatureUtils.createKey(UsefulFoundation.getId("ore_lead").toString());
    public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_NICKEL = FeatureUtils.createKey(UsefulFoundation.getId("ore_nickel").toString());
    public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_PLATINUM = FeatureUtils.createKey(UsefulFoundation.getId("ore_platinum").toString());
    public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_SILVER = FeatureUtils.createKey(UsefulFoundation.getId("ore_silver").toString());
    public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_TIN = FeatureUtils.createKey(UsefulFoundation.getId("ore_tin").toString());
    public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_URANIUM = FeatureUtils.createKey(UsefulFoundation.getId("ore_uranium").toString());
