...
public class FoundationRecipeProvider extends RecipeProvider {
    ...
    protected void buildCraftingRecipes(@Nonnull Consumer<FinishedRecipe> recipe) {
        //Ingots
        ShapedRecipeBuilder.shaped(ALUMINUM_INGOT).pattern("XXX").pattern("XXX").pattern("XXX").define('X', NUGGETS_ALUMINUM).unlockedBy("has_aluminum_nugget", has(NUGGETS_ALUMINUM)).save(recipe, getId("aluminum_ingot_from_nuggets"));
        ...
        ShapedRecipeBuilder.shaped(ENDERIUM_INGOT).pattern("XXX").pattern("XXX").pattern("XXX").define('X', NUGGETS_ENDERIUM).unlockedBy("has_enderium_nugget", has(NUGGETS_ENDERIUM)).save(recipe, getId("enderium_ingot_from_nuggets"));
        ...
        ShapedRecipeBuilder.shaped(PLATINUM_INGOT).pattern("XXX").pattern("XXX").pattern("XXX").define('X', NUGGETS_PLATINUM).unlockedBy("has_platinum_nugget", has(NUGGETS_PLATINUM)).save(recipe, getId("platinum_ingot_from_nuggets"));
        ShapedRecipeBuilder.shaped(SIGNALUM_INGOT).pattern("XXX").pattern("XXX").pattern("XXX").define('X', NUGGETS_SIGNALUM).unlockedBy("has_signalum_nugget", has(NUGGETS_SIGNALUM)).save(recipe, getId("signalum_ingot_from_nuggets"));
        ...
        ShapedRecipeBuilder.shaped(STEEL_INGOT).pattern("XXX").pattern("XXX").pattern("XXX").define('X', NUGGETS_STEEL).unlockedBy("has_steel_nugget", has(NUGGETS_STEEL)).save(recipe, getId("steel_ingot_from_nuggets"));
        ...
        ShapelessRecipeBuilder.shapeless(ALUMINUM_INGOT, 9).requires(BLOCKS_ALUMINUM).unlockedBy("has_aluminum_block", has(BLOCKS_ALUMINUM)).save(recipe, getId("aluminum_ingot_from_aluminum_block"));
        ...
        ShapelessRecipeBuilder.shapeless(ENDERIUM_INGOT, 9).requires(BLOCKS_ENDERIUM).unlockedBy("has_enderium_block", has(BLOCKS_ENDERIUM)).save(recipe, getId("enderium_ingot_from_enderium_block"));
        ...
        ShapelessRecipeBuilder.shapeless(PLATINUM_INGOT, 9).requires(BLOCKS_PLATINUM).unlockedBy("has_platinum_block", has(BLOCKS_PLATINUM)).save(recipe, getId("platinum_ingot_from_platinum_block"));
        ShapelessRecipeBuilder.shapeless(SIGNALUM_INGOT, 9).requires(BLOCKS_SIGNALUM).unlockedBy("has_silver_block", has(BLOCKS_SIGNALUM)).save(recipe, getId("signalum_ingot_from_signalum_block"));
        ...
        ShapelessRecipeBuilder.shapeless(STEEL_INGOT, 9).requires(BLOCKS_STEEL).unlockedBy("has_steel_block", has(BLOCKS_STEEL)).save(recipe, getId("steel_ingot_from_steel_block"));
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(RAW_MATERIALS_ALUMINUM), ALUMINUM_INGOT, 0.7F, 100).unlockedBy("has_raw_aluminum", has(RAW_MATERIALS_ALUMINUM)).save(recipe, getId("aluminum_ingot_from_smelting_raw_aluminum"));
        SimpleCookingRecipeBuilder.blasting(Ingredient.of(RAW_MATERIALS_ALUMINUM), ALUMINUM_INGOT, 0.7F, 50).unlockedBy("has_raw_aluminum", has(RAW_MATERIALS_ALUMINUM)).save(recipe, getId("aluminum_ingot_from_blasting_raw_aluminum"));
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(RAW_MATERIALS_PLATINUM), PLATINUM_INGOT, 0.7F, 250).unlockedBy("has_raw_platinum", has(RAW_MATERIALS_PLATINUM)).save(recipe, getId("platinum_ingot_from_smelting_raw_platinum"));
        SimpleCookingRecipeBuilder.blasting(Ingredient.of(RAW_MATERIALS_PLATINUM), PLATINUM_INGOT, 0.7F, 150).unlockedBy("has_raw_platinum", has(RAW_MATERIALS_PLATINUM)).save(recipe, getId("platinum_ingot_from_blasting_raw_platinum"));
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(ORES_ALUMINUM), ALUMINUM_INGOT, 0.7F, 200).unlockedBy("has_aluminum_ore", has(ORES_ALUMINUM)).save(recipe, getId("aluminum_ingot_from_smelting_aluminum_ore"));
        SimpleCookingRecipeBuilder.blasting(Ingredient.of(ORES_ALUMINUM), ALUMINUM_INGOT, 0.7F, 100).unlockedBy("has_aluminum_ore", has(ORES_ALUMINUM)).save(recipe, getId("aluminum_ingot_from_blasting_aluminum_ore"));
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(ORES_PLATINUM), PLATINUM_INGOT, 0.7F, 200).unlockedBy("has_platinum_ore", has(ORES_PLATINUM)).save(recipe, getId("platinum_ingot_from_smelting_platinum_ore"));
        SimpleCookingRecipeBuilder.blasting(Ingredient.of(ORES_PLATINUM), PLATINUM_INGOT, 0.7F, 100).unlockedBy("has_platinum_ore", has(ORES_PLATINUM)).save(recipe, getId("platinum_ingot_from_blasting_platinum_ore"));
        ...
        //Raw Materials
        ShapelessRecipeBuilder.shapeless(RAW_ALUMINUM, 9).requires(RAW_BLOCKS_ALUMINUM).unlockedBy("has_raw_aluminum", has(RAW_BLOCKS_ALUMINUM)).save(recipe, getId("raw_aluminum_from_raw_aluminum_block"));
        ...
        ShapelessRecipeBuilder.shapeless(RAW_PLATINUM, 9).requires(RAW_BLOCKS_PLATINUM).unlockedBy("has_raw_platinum", has(RAW_BLOCKS_PLATINUM)).save(recipe, getId("raw_platinum_from_raw_platinum_block"));
        ...
        //Gears
        ShapedRecipeBuilder.shaped(ALUMINUM_GEAR).pattern(" X ").pattern("X X").pattern(" X ").define('X', INGOTS_ALUMINUM).unlockedBy("has_aluminum_ingot", has(INGOTS_ALUMINUM)).save(recipe);
        ...
        ShapedRecipeBuilder.shaped(COPPER_GEAR).pattern(" X ").pattern("X X").pattern(" X ").define('X', Tags.Items.INGOTS_COPPER).unlockedBy("has_copper_ingot", has(Tags.Items.INGOTS_COPPER)).save(recipe);
        ShapedRecipeBuilder.shaped(DIAMOND_GEAR).pattern(" X ").pattern("X X").pattern(" X ").define('X', Tags.Items.GEMS_DIAMOND).unlockedBy("has_diamond_gem", has(Tags.Items.GEMS_DIAMOND)).save(recipe);
        ...
        ShapedRecipeBuilder.shaped(ENDERIUM_GEAR).pattern(" X ").pattern("X X").pattern(" X ").define('X', INGOTS_ENDERIUM).unlockedBy("has_enderium_ingot", has(INGOTS_ENDERIUM)).save(recipe);
        ...
        ShapedRecipeBuilder.shaped(PLATINUM_GEAR).pattern(" X ").pattern("X X").pattern(" X ").define('X', INGOTS_PLATINUM).unlockedBy("has_platinum_ingot", has(INGOTS_PLATINUM)).save(recipe);
        ShapedRecipeBuilder.shaped(SIGNALUM_GEAR).pattern(" X ").pattern("X X").pattern(" X ").define('X', INGOTS_SIGNALUM).unlockedBy("has_signalum_ingot", has(INGOTS_SIGNALUM)).save(recipe);
        ...
        ShapedRecipeBuilder.shaped(STEEL_GEAR).pattern(" X ").pattern("X X").pattern(" X ").define('X', INGOTS_STEEL).unlockedBy("has_steel_ingot", has(INGOTS_STEEL)).save(recipe);
        ...
        //Plates
        ShapelessRecipeBuilder.shapeless(ALUMINUM_PLATE).requires(INGOTS_ALUMINUM).requires(HAMMER).unlockedBy("has_aluminum_ingot", has(INGOTS_ALUMINUM)).save(recipe);
        ...
        ShapelessRecipeBuilder.shapeless(COPPER_PLATE).requires(Tags.Items.INGOTS_COPPER).requires(HAMMER).unlockedBy("has_copper_ingot", has(Tags.Items.INGOTS_COPPER)).save(recipe);
        ShapelessRecipeBuilder.shapeless(DIAMOND_PLATE).requires(Tags.Items.GEMS_DIAMOND).requires(HAMMER).unlockedBy("has_diamond_gem", has(Tags.Items.GEMS_DIAMOND)).save(recipe);
        ...
        ShapelessRecipeBuilder.shapeless(ENDERIUM_PLATE).requires(INGOTS_ENDERIUM).requires(HAMMER).unlockedBy("has_enderium_ingot", has(INGOTS_ENDERIUM)).save(recipe);
        ...
        ShapelessRecipeBuilder.shapeless(PLATINUM_PLATE).requires(INGOTS_PLATINUM).requires(HAMMER).unlockedBy("has_platinum_ingot", has(INGOTS_PLATINUM)).save(recipe);
        ShapelessRecipeBuilder.shapeless(SIGNALUM_PLATE).requires(INGOTS_SIGNALUM).requires(HAMMER).unlockedBy("has_signalum_ingot", has(INGOTS_SIGNALUM)).save(recipe);
        ...
        ShapelessRecipeBuilder.shapeless(STEEL_PLATE).requires(INGOTS_STEEL).requires(HAMMER).unlockedBy("has_steel_ingot", has(INGOTS_STEEL)).save(recipe);
        ...
        //Nuggets
        ShapelessRecipeBuilder.shapeless(ALUMINUM_NUGGET, 9).requires(INGOTS_ALUMINUM).unlockedBy("has_aluminum_ingot", has(INGOTS_ALUMINUM)).save(recipe);
        ...
        ShapelessRecipeBuilder.shapeless(COPPER_NUGGET, 9).requires(Tags.Items.INGOTS_COPPER).unlockedBy("has_copper_ingot", has(Tags.Items.INGOTS_COPPER)).save(recipe);
        ...
        ShapelessRecipeBuilder.shapeless(ENDERIUM_NUGGET, 9).requires(INGOTS_ENDERIUM).unlockedBy("has_enderium_ingot", has(INGOTS_ENDERIUM)).save(recipe);
        ...
        ShapelessRecipeBuilder.shapeless(PLATINUM_NUGGET, 9).requires(INGOTS_PLATINUM).unlockedBy("has_platinum_ingot", has(INGOTS_PLATINUM)).save(recipe);
        ShapelessRecipeBuilder.shapeless(SIGNALUM_NUGGET, 9).requires(INGOTS_SIGNALUM).unlockedBy("has_signalum_ingot", has(INGOTS_SIGNALUM)).save(recipe);
        ...
        ShapelessRecipeBuilder.shapeless(STEEL_NUGGET, 9).requires(INGOTS_STEEL).unlockedBy("has_steel_ingot", has(INGOTS_STEEL)).save(recipe);
        ...
        ShapedRecipeBuilder.shaped(ENDERIUM_BLOCK).pattern("XXX").pattern("XXX").pattern("XXX").define('X', INGOTS_ENDERIUM).unlockedBy("has_enderium_ingot", has(INGOTS_ENDERIUM)).save(recipe);
        ...
        ShapedRecipeBuilder.shaped(PLATINUM_BLOCK).pattern("XXX").pattern("XXX").pattern("XXX").define('X', INGOTS_PLATINUM).unlockedBy("has_platinum_ingot", has(INGOTS_PLATINUM)).save(recipe);
        ShapedRecipeBuilder.shaped(SIGNALUM_BLOCK).pattern("XXX").pattern("XXX").pattern("XXX").define('X', INGOTS_SIGNALUM).unlockedBy("has_silver_ingot", has(INGOTS_SIGNALUM)).save(recipe);
        ...
        ShapedRecipeBuilder.shaped(STEEL_BLOCK).pattern("XXX").pattern("XXX").pattern("XXX").define('X', INGOTS_STEEL).unlockedBy("has_steel_ingot", has(INGOTS_STEEL)).save(recipe);
        ...
        //Raw Storage Blocks
        ShapedRecipeBuilder.shaped(RAW_ALUMINUM_BLOCK).pattern("XXX").pattern("XXX").pattern("XXX").define('X', RAW_MATERIALS_ALUMINUM).unlockedBy("has_raw_aluminum", has(RAW_MATERIALS_ALUMINUM)).save(recipe);
        ShapedRecipeBuilder.shaped(RAW_LEAD_BLOCK).pattern("XXX").pattern("XXX").pattern("XXX").define('X', RAW_MATERIALS_LEAD).unlockedBy("has_raw_lead", has(RAW_MATERIALS_LEAD)).save(recipe);
        ShapedRecipeBuilder.shaped(RAW_NICKEL_BLOCK).pattern("XXX").pattern("XXX").pattern("XXX").define('X', RAW_MATERIALS_NICKEL).unlockedBy("has_raw_nickel", has(RAW_MATERIALS_NICKEL)).save(recipe);
        ShapedRecipeBuilder.shaped(RAW_PLATINUM_BLOCK).pattern("XXX").pattern("XXX").pattern("XXX").define('X', RAW_MATERIALS_PLATINUM).unlockedBy("has_raw_platinum", has(RAW_MATERIALS_PLATINUM)).save(recipe);
        ShapedRecipeBuilder.shaped(RAW_SILVER_BLOCK).pattern("XXX").pattern("XXX").pattern("XXX").define('X', RAW_MATERIALS_SILVER).unlockedBy("has_raw_silver", has(RAW_MATERIALS_SILVER)).save(recipe);
        ShapedRecipeBuilder.shaped(RAW_TIN_BLOCK).pattern("XXX").pattern("XXX").pattern("XXX").define('X', RAW_MATERIALS_TIN).unlockedBy("has_raw_tin", has(RAW_MATERIALS_TIN)).save(recipe);
        ShapedRecipeBuilder.shaped(RAW_URANIUM_BLOCK).pattern("XXX").pattern("XXX").pattern("XXX").define('X', RAW_MATERIALS_URANIUM).unlockedBy("has_raw_uranium", has(RAW_MATERIALS_URANIUM)).save(recipe);
