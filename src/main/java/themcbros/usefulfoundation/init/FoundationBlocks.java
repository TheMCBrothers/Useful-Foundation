...
public class FoundationBlocks {
    ...
    public static final Block RAW_BRONZE_BLOCK = register("raw_bronze_block", new Block(Block.Properties.of(Material.METAL).strength(5f).sound(SoundType.METAL).requiresCorrectToolForDrops()));
    ...
    public static final Block RAW_INVAR_BLOCK = register("raw_invar_block", new Block(Block.Properties.of(Material.METAL).strength(5f).sound(SoundType.METAL).requiresCorrectToolForDrops()));
    ...
    public static final Block RAW_ELECTRUM_BLOCK = register("raw_electrum_block", new Block(Block.Properties.of(Material.METAL).strength(5f).sound(SoundType.METAL).requiresCorrectToolForDrops()));
